    ...
    return (
        <div className="banner" style={bannerStyle}>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-4">
                <a href="#" className="inline-flex items-center justify-center px-4 py-2 text-[#7984EB] hover:bg-purple-50 transition-colors text-[0.875rem]">
                ...
                <a href="#" className="inline-flex items-center justify-center px-4 py-2 text-purple-600 rounded-lg border border-[#DD7BFF] hover:bg-purple-50 transition-colors text-[0.875rem]">
                    Report mistakes
                </a>
                <a href="#" className="inline-flex items-center justify-center px-4 py-2 text-purple-600 rounded-lg border border-[#DD7BFF] hover:bg-purple-50 transition-colors text-[0.875rem]">
                Request to remove
