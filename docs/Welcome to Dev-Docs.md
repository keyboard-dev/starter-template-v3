...
![](/img/desktop.png)Just Drag and drop and then click "install". From there you will prompted to add a GitHub PAT. Before you do that please go fork: <https://github.com/keyboard-dev/codespace-executor>.\
\
